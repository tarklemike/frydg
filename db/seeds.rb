...
foodbank_6 = Foodbank.create!(:name => "Food4all", :address => "150 Southgate Road, London, NW1", telephone: "020 7707 8700")
foodbank_7 = Foodbank.create!(:name => "Foodisyourright", :address => "15 Columbia Road, London, E1", telephone: "020 7777 5250")
foodbank_8 = Foodbank.create!(:name => "Comidaparatodos", :address => "45 Old Street, London, EC1", telephone: "020 7967 5252")
foodbank_9 = Foodbank.create!(:name => "Nohunger", :address => "Kilburn High Road, London, NW6", telephone: "020 7857 8800")
